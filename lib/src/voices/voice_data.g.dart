...
part of 'voice_data.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

VoiceData _$VoiceDataFromJson(Map<String, dynamic> json) => VoiceData(
...
Map<String, dynamic> _$VoiceDataToJson(VoiceData instance) => <String, dynamic>{
      'Name': instance.name,
